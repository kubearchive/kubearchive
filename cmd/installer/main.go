...
import (
	...
	"github.com/kubearchive/kubearchive/cmd/installer/internal/controller"
	webhookv1 "github.com/kubearchive/kubearchive/cmd/installer/internal/webhook/v1"
...
func init() {
	...
	utilruntime.Must(kubearchiveorgv1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "dcaee278.kubearchive.org",
