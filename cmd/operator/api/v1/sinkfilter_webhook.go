...
//+kubebuilder:webhook:path=/mutate-kubearchive-org-v1-sinkfilter,mutating=true,failurePolicy=fail,sideEffects=None,groups=kubearchive.org,resources=sinkfilter,verbs=create;update,versions=v1,name=msinkfilter.kb.io,admissionReviewVersions=v1
...
//+kubebuilder:webhook:path=/validate-kubearchive-org-v1-sinkfilter,mutating=false,failurePolicy=fail,sideEffects=None,groups=kubearchive.org,resources=sinkfilter,verbs=create;update,versions=v1,name=vsinkfilter.kb.io,admissionReviewVersions=v1
