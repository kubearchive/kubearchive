...
----
# For Linux AMD64
curl -sSfLO {download-path}/kubectl-ka-linux-amd64

# For Linux ARM64
curl -sSfLO {download-path}/kubectl-ka-linux-arm64

# For Darwin AMD64
curl -sSfLO {download-path}/kubectl-ka-darwin-amd64

# For Darwin ARM64
curl -sSfLO {download-path}/kubectl-ka-darwin-arm64
----
