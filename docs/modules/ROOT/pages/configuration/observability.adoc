...
* `KUBEARCHIVE_TRACE_SAMPLING_RATE`: a floating point number between 0.0 and 1.0 that is used as the sampling rate for
...
`KUBEARCHIVE_TRACE_SAMPLING_RATE` to "0.1". With this configuration, only 10% of new traces created by KubeArchive are
