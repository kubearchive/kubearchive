...
Welcome to the Kronicler project! We are happy that you find this project
...
link:https://github.com/kronicler/kronicler/issues[Bug Tracker].
For security reports, send an e-mail to the
link:mailto:kronicler-security@googlegroups.com[Security e-mail address].
...
By contributing to Kronicler you accept the Developer Certificate of
...
* link:https://github.com/kronicler/kronicler/issues[Bug Tracker]
* link:https://github.com/kronicler/community/blob/main/CODE_OF_CONDUCT.md[Code of Conduct]
* link:https://github.com/orgs/kronicler/discussions[Discussions]
* link:https://groups.google.com/g/kronicler[Mailing list]
* link:https://groups.google.com/g/kronicler-developers[Developers mailing list]
* link:https://groups.google.com/g/kronicler-coc[Code Of Conduct mailing list]
* link:https://groups.google.com/g/kronicler-security[Security mailing list]
