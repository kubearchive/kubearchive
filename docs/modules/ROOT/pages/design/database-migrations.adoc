...
* The same database user that KubeArchive uses run the migrations to avoid permissions problems.
...
All migrations have two files: `up` for upgrades and `down` for rollbacks.
