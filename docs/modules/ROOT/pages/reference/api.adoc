...
==== Filter pods created after a specific date
[source,text]
----
GET /api/v1/namespaces/default/pods?creationTimestampAfter=2023-06-01T00:00:00Z
----

==== Filter deployments created before a specific date
[source,text]
----
GET /apis/apps/v1/namespaces/production/deployments?creationTimestampBefore=2023-12-31T23:59:59Z
----

==== Filter resources created within a date range
[source,text]
----
GET /api/v1/pods?creationTimestampAfter=2023-01-01T00:00:00Z&creationTimestampBefore=2023-01-31T23:59:59Z
----

==== Combine timestamp filters with label selectors
[source,text]
----
GET /api/v1/namespaces/default/pods?creationTimestampAfter=2023-06-01T00:00:00Z&labelSelector=app=frontend
----
