...
func (o *LogOptions) Complete(args []string) error {
	...
	if (len(args) == 1 || len(args) == 3 || len(args) == 4) && o.LabelSelector != "" {
	...
	if len(args) == 2 {
		// With two arguments we assume those are POD_NAME and CONTAINER_NAME
		o.GroupVersion = "v1"
		o.Resource = "pods"
		o.Name = args[0]
		o.ContainerName = args[1]

		// With two arguments AND labelSelector we assume args are GROUPVERSION and RESOURCE
		if o.LabelSelector != "" {
