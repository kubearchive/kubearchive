...
If the provided resource owns directly or indirectly a pod, and all the resources in the chain are archived
you can also get the logs one of the containers in the chain (latest one if it is not specified).`
