...
type DBInterface interface {
	QueryResources(ctx context.Context, kind, apiVersion, namespace, name, limit, continueId, continueDate string) ([]string, int64, string, error)
...
func (db *Database) QueryResources(ctx context.Context, kind, apiVersion, namespace, name, limit, continueId, continueDate string) ([]string, int64, string, error) {
