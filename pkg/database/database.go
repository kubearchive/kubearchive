...
type DBInterface interface {
	QueryResources(ctx context.Context, kind, apiVersion, continueId, continueDate string, limit int) ([]*unstructured.Unstructured, int64, string, error)
	QueryNamespacedResources(ctx context.Context, kind, apiVersion, namespace, continueId, continueDate string, limit int) ([]*unstructured.Unstructured, int64, string, error)
...
func (db *Database) QueryResources(ctx context.Context, kind, apiVersion, continueId, continueDate string, limit int,
) ([]*unstructured.Unstructured, int64, string, error) {
...
func (db *Database) QueryNamespacedResources(ctx context.Context, kind, apiVersion, namespace, continueId, continueDate string, limit int) ([]*unstructured.Unstructured, int64, string, error) {
	sb := db.Selector.ResourceSelector()
	sb.Where(
		db.Filter.KindFilter(sb.Cond, kind),
		db.Filter.ApiVersionFilter(sb.Cond, apiVersion),
...
func (db *Database) QueryNamespacedResourceByName(ctx context.Context, kind, apiVersion, namespace, name string) (*unstructured.Unstructured, error) {
	...
	resources, _, _, err := db.performResourceQuery(ctx, sb)
...
func (db *Database) performResourceQuery(ctx context.Context, sb *sqlbuilder.SelectBuilder) ([]*unstructured.Unstructured, int64, string, error) {
